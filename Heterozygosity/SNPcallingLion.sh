...
REFERENCE=../GCA_008795835.1_PanLeo1.0_genomic.fna
#THREADS_BWA=46
...
gatk CombineGVCFs -R $REFERENCE --variant SRR10009886.rg.md.haplotypecaller.g.vcf --variant SRR13242484.rg.md.haplotypecaller.g.vcf --variant SRR836361.rg.md.haplotypecaller.g.vcf --variant SRR836370.rg.md.haplotypecaller.g.vcf -O Lion_n4.g.vcf.gz
gatk --java-options "-Xmx4g" GenotypeGVCFs -R $REFERENCE -V Lion_n4.g.vcf.gz -O Lion_n4.vcf.gz
