...
gatk CombineGVCFs -R $REFERENCE --variant SRR13500746.rg.md.haplotypecaller.g.vcf --variant SRR13500748.rg.md.haplotypecaller.g.vcf --variant SRR13500752.rg.md.haplotypecaller.g.vcf --variant SRR13500756.rg.md.haplotypecaller.g.vcf --variant SRR13500762.rg.md.haplotypecaller.g.vcf -O Bengal_n5.g.vcf.gz
gatk --java-options "-Xmx4g" GenotypeGVCFs -R $REFERENCE -V Bengal_n5.g.vcf.gz -O Bengal_n5.vcf.gz
