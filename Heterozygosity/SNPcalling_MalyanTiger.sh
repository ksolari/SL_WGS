...
gatk CombineGVCFs -R $REFERENCE --variant SRR13647621.rg.md.haplotypecaller.g.vcf --variant SRR13647627.rg.md.haplotypecaller.g.vcf --variant SRS8209294.rg.md.haplotypecaller.g.vcf --variant SRS8209296.rg.md.haplotypecaller.g.vcf --variant SRS8209300.rg.md.haplotypecaller.g.vcf -O Malayan_n5.g.vcf.gz
gatk --java-options "-Xmx4g" GenotypeGVCFs -R $REFERENCE -V Malayan_n5.g.vcf.gz -O Malayan_n5.vcf.gz
