...
gatk CombineGVCFs -R $REFERENCE --variant SRR13647577.rg.md.haplotypecaller.g.vcf --variant SRR13647578.rg.md.haplotypecaller.g.vcf --variant SRR13647591.rg.md.haplotypecaller.g.vcf --variant SRS8209305.rg.md.haplotypecaller.g.vcf --variant SRS8209313.rg.md.haplotypecaller.g.vcf -O Sumatran_n5.g.vcf.gz
gatk --java-options "-Xmx4g" GenotypeGVCFs -R $REFERENCE -V Sumatran_n5.g.vcf.gz -O Sumatran_n5.vcf.gz
